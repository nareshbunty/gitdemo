...
<html ng-app="coupon-delete-controller">
<head>
...
angular.module('coupon-delete-controller', []).
controller('delete_coupon_controller', ['$scope', '$window','$http',function($scope,$window,$http) {
	$scope.deleteDiscount()=function(){
		$http({
			method:"post",
			url:"/HappyBus/deleteCouponDetails",
			params:{
...
<!-- page content -->
<body>
<div class="right_col" role="main" ng-controller="delete_coupon_controller">
	<div class="">
						...
						<form class="form-horizontal form-label-left" novalidate>
							...
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="name">Enter Coupon Code To Delete<span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="name" class="form-control col-md-7 col-xs-12"
										data-validate-length-range="6" data-validate-words="2"
										name="disCost" ng-model="couponcode" placeholder="e.g 10%"
