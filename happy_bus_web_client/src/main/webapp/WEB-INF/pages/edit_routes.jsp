<html data-ng-app="edit_routes.controllers">
...
<script type="text/javascript">
	angular.module('edit_routes.controllers', []).controller(
			'edit_routes_controller',
...
<div class="right_col" role="main"
	data-ng-controller="edit_routes_controller">
	<form class="form-horizontal form-label-left" novalidate>
		<div data-ng-show="search_bus_div">
			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<label class="control-label col-md-3 col-sm-3 col-xs-12"
						for="travelId">TravelId<span class="required">*</span>
					</label> <input id="name" class="form-control col-md-7 col-xs-12"
						data-validate-length-range="6" data-validate-words="1"
