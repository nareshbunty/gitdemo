...
<script type="text/javascript">
	...
	$scope.searchBookingForTravelAdmin = function() {
				
$http(
{
	method : "post",
	url : "/HappyBus/searchBooking2",
	params : {
...
.then(
	...
	function(response) {
		$window.alert("unable to process your request from happy_search_booking_by_travel_admin");
	});
  }
} ]);
</script>
						...
						<form class="form-horizontal form-label-left" novalidate>
							...
							<div class="form-group">
								<div class="col-md-6 col-md-offset-3">
									&nbsp;&nbsp;&nbsp;
									<button class="btn btn-success" ng-click="searchBookingForTravelAdmin()">Search</button>
									&nbsp;&nbsp;&nbsp;&nbsp;
