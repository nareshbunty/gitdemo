...
angular.module('discount-controller', ['720kb.datepicker']).
controller('insert_discount_controller', ['$scope', '$window','$http',function($scope,$window,$http) {
	...
	$scope.insertDiscount=function(){
		...
		$http({
			...
			method:"POST",
			url:"/HappyBus/discountDetails",
			params:{
				
				"discountAmount":$scope.disCost,
...
<!-- page content -->
<body>
<div class="right_col" role="main" ng-controller="insert_discount_controller">
	<div class="">
						...
						<form class="form-horizontal form-label-left" novalidate>
							...
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="name">Enter Discount Cost<span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="name" class="form-control col-md-7 col-xs-12"
										data-validate-length-range="6" data-validate-words="2"
										name="disCost" ng-model="disCost" placeholder="e.g 10%"
                         ...
                         <input type="text" ng-model="validfrom"  class="form-control col-md-7 col-xs-12"/>
							...
							<div class="form-group">
								<div class="col-md-6 col-md-offset-3">
									...
									<button id="send" type="submit"  ng-click="insertDiscount()" class="btn btn-success">Submit</button>
								</div>
							</div>
						</form>
					</div>
